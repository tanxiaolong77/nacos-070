...
public class VirtualClusterDomain implements Domain, RaftListener {
    ...
    public void onChange(String key, String value) throws Exception {
        ...
        updateIPs(ips);//推送更变消息给订阅者 name=com.sam.service.UserService，默认会重新发送2次
    ...
    /***
     * 发送推送
     * 推送更变消息给订阅者 name=com.sam.service.UserService，
     * 默认会重新发送2次
     * @param ips
     */
    public void updateIPs(List<IpAddress> ips) {
        ...
        PushService.domChanged(name);//推送更变消息给订阅者 name=com.sam.service.UserService，默认会重新发送2次
