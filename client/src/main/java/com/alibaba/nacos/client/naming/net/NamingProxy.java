...
public class NamingProxy {
    ...
    public void registerService(String serviceName, Instance instance) throws NacosException {
        ...
        reqAPI(UtilAndComs.NACOS_URL_INSTANCE, params, "PUT");//使用put的方式访问nacos服务器
    }
    ...
    public String callServer(String api, Map<String, String> params, String curServer, String method)
        ...
        //发送至 nacos-naming项目中的InstanceController的register方法中进行注册
    ...
    public String reqAPI(String api, Map<String, String> params, List<String> servers, String method) {
        ...
        if (servers != null && !servers.isEmpty()) {
            ...
            for (int i = 0; i < servers.size(); i++) {
                String server = servers.get(index);//默认使用随机算法来选出一个server进行callServer
                try {
